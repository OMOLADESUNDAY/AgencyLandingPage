...
const Navbar = () => {
  ...
  return (
    <div className="container flex items-start my-5 justify-between m-auto relative md:items-center">
      ...
      <nav className={navOpen?"flex items-center absolute  left-1/2 -translate-x-1/2 flex-col md:flex-row":"flex items-center absolute  left-1/2 -translate-x-1/2 flex-col hidden md:flex-row"}>
        <div className="menu">
        ...
        <button className="flex items-center btn-primary md:hidden">
      ...
      <button className="flex items-center btn-primary hidden md:flex">
        ...
        {navOpen?<X className=" cursor-pointer md:hidden z-20" onClick={()=>MenuToggler()}/>:<Menu className="cursor-pointer md:hidden z-20" onClick={()=>MenuToggler()}/>}
    </div>
  );
};
